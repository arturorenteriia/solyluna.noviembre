    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
            @foreach($pictures as $pic)
                <div>
                    <img u="image" src="{{ asset('uploads') }}/{{ $property->image }}" />
                    <img u="thumb" src="{{ asset('uploads') }}/{{ $property->image }}" />
                </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image1 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image1 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image2 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image2 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image3}}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image3 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image4 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image4 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image5 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image5 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image6 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image6 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image7 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image7 }}" />
            </div>
            <div>
                <img u="image" src="{{ asset('carousel') }}/{{ $pic->image8 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image8 }}" />
            </div>
            <div>
                <img u="image" src=" {{ asset('carousel') }}/{{ $pic->image9 }}" />
                <img u="thumb" src="{{ asset('carousel') }}/{{ $pic->image9 }}" />
            </div>
        ...
        <ul class="collection hoverable">
            ...
            <span class="title"><b>Property Status</b></span>
             ...
             <p class="green-text">Available </p>
              ...
              <p class="red-text">Not available </p>
               ...
               Available Rooms: {{ $property->num_bedrooms }}<br>
          ...
          <li class="collection-item avatar hoverable">
            ...
            <span class="title"><b>Services</b></span>
              @foreach($service_a as $services)


                      <p>*{{ $services->amenity}}<br>
          ...
          <li class="collection-item avatar hoverable">
            ...
            <p>@foreach($technology_a as $technology)


                  <p>*{{ $technology->amenity}}<br>
          ...
          <div class="col s12 m12 l3">
            <div class="card big hoverable">
              ...
              <div class="card-action">
                  ...
                  {!! Form::close() !!}
                  <a href="#" onclick="javascript:document.form1.submit()" title="See more">See More</a>
