    ...
    <div class="row">
        <div class="col s12 m12 l12 ">
            <div class="card-panel blue">
                ...
                <center><span class="white-text" ><h5>Resorts not found by {{$service->service}}</h5></span></center>
                @endif
                @if(!Session::has('message'))
                        <center><span class="white-text" ><h5>Resorts found by {{$service->service}}</h5></span></center>
                @endif
            </div>
        </div>
    </div>
