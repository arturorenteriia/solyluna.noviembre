    ...
    <div class="row">
        <div class="col s12 m12 l12 ">
            <div class="card-panel blue">
                ...
                <center><span class="white-text" ><h5>{{$service->service}} Health Resorts not available</h5></span></center>
                @endif
                @if(!Session::has('message'))
                        <center><span class="white-text" ><h5>{{$service->service}} Health Resorts Located</h5></span></center>
                @endif
            </div>
        </div>
    </div>
                ...
                <div class="col s12 m12 l3">
                    <div class="card small hoverable">
                        ...
                        <div class="card-action">
                            {!! Form::open(['route' => 'vistas.vistapropiedad', 'method' => 'get', 'class' => 'col s12 m12 s3' ]) !!}
