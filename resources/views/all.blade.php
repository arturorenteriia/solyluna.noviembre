    ...
    <div class="row">
        <div class="col s12 m12 l12 ">
            <div class="card-panel blue">
                <center><span class="white-text" ><h5>Sol & Luna Exclusive Health Resorts</h5>
          </span></center>
                ...
                <div class="col s12 m12 l3">
                    <div class="card small hoverable">
                        <div class="card-image"  alt="">
                            <a  class="brand-logo"> <img src="{{ asset('uploads') }}/{{ $property->image }}" height="180px"></a>
                            <a  class="brand-logo"><span class="card-title ">{{ $property->name }}</span></a>
                        </div>
                        <div class="card-content">
                            <a  class="brand-logo">  <p class="grey-text text-darken-2">{{ $property->slogan }} 
                           </p></a>
                        </div>
