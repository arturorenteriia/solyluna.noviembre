  ...
  <div class="row">
    <div class="parallax-container">
      ...
      <div class="caption center-align">
            <h3 class="white-text text-darken-2" style="margin-top: 250px">Gastronomy ...</h3>
            <h5 class="light grey-text text-lighten-3">Sol & Luna Health Exclusive Resorts</h5>
        </div>
    </div>
  </div>
    ...
    <div class="card-panel white"> <!-- Card panel -->
      ...
      <div class="row">
        <div class="col s12">
          ...
          <div class="col s12 m4 l4 hoverable">
            <div class="col s12 m12 l12 ">
             <center> <a href="images/menucasasayulita.pdf" TARGET="_blank"><img src="personaliza tu menu.jpg" class="responsive-img z-depth-2" alt="" style="width: 207px; height: 231px;"></a></center>
            </div>
            <div class="col s12 m12 l12 ">
