 ...
 <script>
  ...
  <div class="row">
      <div class="col s12 m12 l12 ">
        ...
        <center><span class="white-text" ><h5>RESIDENCIA AMAPA</h5>
          </span></center>
...
@section('form_residencias')
 ...
 <div class="col s12 m12 l9"> <!-- Note that "m8 l9" was added -->
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
            <div>
                <img u="image" src="images/alila/residenciaamapa.jpg" />
 ...
 <div class="row">
        ...
        <div class="card-panel">
          <h5 class="grey-text text-darken-4">RESIDENCIA AMAPA</h5>
          ...
          <li class="collection-item avatar hoverable">
            ...
            <span class="title"><b>Property Status</b></span>
             <p class="green-text">Available </p>
               <p>Service: Independent/Assisting Living<br>
               Location: Nuevo Vallarta, Nayarit, Mexico   <br>
               Bedrooms: 6<br>
               Available Rooms: 5<br>
